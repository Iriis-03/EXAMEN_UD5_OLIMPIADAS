...
public class JuegosInviernoApp {
    public static void main(String[] args) {
        ...
        //b)
        System.out.println("\n" + espanya.getPais() + " ha conseguido " +
                espanya.medallasTotales() + " medallas.");;
        //c)
        espanya.verMedallero();

        //d)
        System.out.println("\n El deportista de " + espanya.getPais() + "
                que más medallas ha ganado es " + espanya.deportistaTOP().getNombre());
                //e)
